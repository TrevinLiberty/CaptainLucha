...
{
	//Converts the model file at filePath in a .lm model file and exports it to exportDirectory.
	//	This will create a new folder in exportDirectory named using the original file's name.
	//	The folder will contain a sub folder that will have all the needed textures for the model.
	//		All texture path's start from the newly create model folder.
	//
	//Attention. This assumes that filePath is directed to a model that assimp supports.
	//
	//	Example .lm file
	//	Everything in quotes represent a variable that can change. Note, NodeName is in double quotes.
